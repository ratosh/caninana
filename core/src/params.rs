...
pub const DOUBLE_GAS_PER_BASE_WORKERS: usize = 60;
pub const UNLOCK_ROACH_WORKERS: usize = 26;
pub const UNLOCK_HYDRA_WORKERS: usize = 42;
pub const UNLOCK_LATE_TECH_WORKERS: usize = MAX_WORKERS - 4;
pub const UNLOCK_REALLY_LATE_TECH_WORKERS: usize = MAX_WORKERS - 2;
...
pub const CREEP_DISTANCE_TO_HALL: f32 = 3f32;
